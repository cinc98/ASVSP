# Ukupan broj prekrsaja po godini (2009-2019) za svaku policijsku stanicu
...
df.join(df_json, df["precinct"] == df_json["id"]).drop('precinct','id','address','officer').show(df.count(),False)
